...
bool SystemSetting::LoadSystemSetting(const std::string strSettingPath) {
  ...
  // shinan added parameter for DR + SE

  DistCamFromCenter_h = fSettings["Robot.distCameraFromRobotCenter_x"];
  DistCamFromCenter_v = fSettings["Robot.distCameraFromRobotCenter_z"];
